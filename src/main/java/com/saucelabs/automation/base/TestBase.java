package com.saucelabs.automation.base;
...
import com.saucelabs.automation.util.WebEventListner;
...
public class TestBase extends DriverInit {
	...
	public TestBase() {
		...
		prop = new Properties();
		try {																				   
			FileInputStream configFile = new FileInputStream (System.getProperty("user.dir") + "/src/main/java/com/saucelabs/automation/config/config.properties");
	...
	public  void launchBrowser(){
		...
		driver.get(URL);
		logger.info("URL on " + URL +" is launched");
	}
